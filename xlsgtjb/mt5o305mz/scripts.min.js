 ...
 * @requires jQuery
 */
var Class=Class||{};$.extend(Class,{create:function(a){var b=a||{};return function(){var a,c;a={superclass:b.prototype,rebase:function(a){this[a]=$.extend(!0,{},this[a])}},c=["unbind","bind","trigger","on","off"],$.each(c,function(b,c){$.isFunction($.fn[c])&&(a[c]=function(){$.fn[c].apply($(this),arguments)})}),$.extend(!0,a,b.prototype,this),$.extend(!0,this,a),$.isFunction(this.initialize)&&this.initialize.apply(this,arguments)}},get:function(a,b){var c=this.create(b);return c.prototype=a,c}}),function(a){"use strict";a.fn.fitVids=function(b){var c={customSelector:null},d=document.createElement("div"),e=document.getElementsByTagName("base")[0]||document.getElementsByTagName("script")[0];return d.className="fit-vids-style",d.innerHTML="&shy;<style>               .fluid-width-video-wrapper {                 width: 100%;                              position: relative;                       padding: 0;                            }                                                                                   .fluid-width-video-wrapper iframe,        .fluid-width-video-wrapper object,        .fluid-width-video-wrapper embed {           position: absolute;                       top: 0;                                   left: 0;                                  width: 100%;                              height: 100%;                          }                                       </style>",e.parentNode.insertBefore(d,e),b&&a.extend(c,b),this.each(function(){var b=["iframe[src*='player.vimeo.com']","iframe[src*='www.youtube.com']","iframe[src*='www.youtube-nocookie.com']","iframe[src*='www.kickstarter.com']","object","embed"];c.customSelector&&b.push(c.customSelector);var d=a(this).find(b.join(","));d.each(function(){var b=a(this);if(!("embed"===this.tagName.toLowerCase()&&b.parent("object").length||b.parent(".fluid-width-video-wrapper").length)){var c="object"===this.tagName.toLowerCase()||b.attr("height")&&!isNaN(parseInt(b.attr("height"),10))?parseInt(b.attr("height"),10):b.height(),d=isNaN(parseInt(b.attr("width"),10))?b.width():parseInt(b.attr("width"),10),e=c/d;if(!b.attr("id")){var f="fitvid"+Math.floor(999999*Math.random());b.attr("id",f)}b.wrap('<div class="fluid-width-video-wrapper"></div>').parent(".fluid-width-video-wrapper").css("padding-top",100*e+"%"),b.removeAttr("height").removeAttr("width")}})})}}(jQuery),/*!
   --------------------------------
   Infinite Scroll
   --------------------------------
...
a.run=function(a){var c,d;if(a){if(!a.posts.length)return void this.trigger(this.EVENT_COMPLETE);for(c=0;c<a.posts.length;c+=1){if(this.posts.length>=this.config("maxNum"))return void this.trigger(this.EVENT_COMPLETE);d=a.posts[c],this.posts.push(d),d.tags&&(this.tags=this.tags.concat(d.tags))}this.offset+=this.step,this.trigger(this.EVENT_PROGRESS)}else this.posts=[],this.tags=[];return b.ajax({url:this.option.url,data:{start:this.offset,num:this.step},dataType:"jsonp",success:b.proxy(this.run,this)}),this},a._createTagData=function(){var a,b,c;for(b={},a=0;a<this.tags.length;a++)c=this.tags[a],b[c]=b[c]?b[c]+1:1;this.tags=[];for(a in b)this.tags.push({name:a,count:b[a]})},/**
	 ...
	 * @return Array
	 */
a.getPosts=function(a,c){var d=[];return a=a||0,c=c||10,b.each(this.posts,function(b,e){return a>b?void 0:b>=a+c?!1:void d.push(e)}),d},/**
	 * Get the tags
	 *
	 * @param String order (optinal)
	 * @return Array
	 */
a.getTags=function(a){var b=this.tags;return a&&b.sort(function(b,c){return"asc"===a?b.count-c.count:"desc"===a?c.count-b.count:void 0}),b},/**
	 ...
	 * @return String
	 */
a.getTitleByPost=function(a,b){var c=a["regular-title"]||a["photo-caption"]||a["video-caption"]||a["regular-body"]||a.type||"";return c=c.replace(/\<.+?\>/gi,""),c=b?c.substr(0,b):c}}(TumblrPosts.prototype,jQuery),$(document).ready(function(){// タグリスト記事出す
!function(){var a=new TumblrPosts({// ドメインと取得する最大記事数
domain:location.host,maxNum:300});a.bind(a.EVENT_COMPLETE,function(){// getTags() でタグリストを取得
$.each(this.getTags(),function(a,b){var c='<li class="level'+(b.count%6+1)+'"><a href="/tagged/'+b.name+'">'+b.name+"</a></li>";$(c).appendTo($("ul#tags"))})}),a.run()}(),// text投稿のyoutubeもレスポンシブにする
$(".post.text iframe[src*='youtube.com']").wrap("<div class='video-iframe'></div>"),$("iframe[src*='tumblr.com']").addClass("video-iframe"),// fitvid
$(".video-iframe").fitVids(),$(".mobile-nav-panel").click(function(){$(".header-box-nav").slideToggle(200)}),$(".header-tags a").click(function(){return $(".tag-list").slideToggle(200),!1}),$(".tag-list .close").click(function(){$(".tag-list").slideToggle(200)});// masonry
var a=$(".index-post-wrapper").css({opacity:0});a.imagesLoaded(function(){a.animate({opacity:1}),a.masonry({itemSelector:".post"})}),// infinite scroll
a.infinitescroll({navSelector:".pagenation-index",nextSelector:".pagenation-index .next",itemSelector:".post",animate:!1,loading:{img:"xlsgtjb/V4Zne2alt/blank.gif",msgText:"<div class='spinner'><div class='rect1'></div><div class='rect2'></div><div class='rect3'></div><div class='rect4'></div><div class='rect5'></div></div>",finishedMsg:""}},function(b){var c=$(b).css({opacity:0});c.imagesLoaded(function(){a.animate({opacity:1}),a.masonry("appended",c,!0)})}),// 外部サイトにはtarget blankする
$("a").each(function(){var a=this;a.origin!==location.origin&&$(a).attr("target","_blank")}),$(window).load(function(){// スマホでphotosetの中をwidth100%にする
$(window).width()<760&&($("iframe.photoset").contents().find(".photoset_row").css({width:"auto",height:"auto",margin:"0"}),$("iframe.photoset").contents().find(".photoset_photo").css({display:"block",margin:"0 0 0 0"}),$("iframe.photoset").contents().find(".photoset_row img").css({width:"100%",margin:"0 0 0 0"}),$("iframe.photoset").css("height",$("iframe.photoset").contents().find("body").height()+"px"))})});